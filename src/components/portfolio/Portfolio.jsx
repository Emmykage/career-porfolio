...
const data = [
  {
    ...
    description:
      "This retail app is built with ReactJS, Ruby on Rails, Redux, and Postgres database. Users can browse, add to a cart and purchase products. ReactJS provides a responsive UI, while Redux manages data flow. Ruby on Rails ensures a secure API, and Postgres offers efficient data management.",
  },
  {
    id: 2,
    image: IMG2,
    ...
    description:
      "ArtisanHub aims to revolutionise the way artisans and clients connect and collaborate, fostering a thriving ecosystem of skilled professionals and satisfi ed customers within Nasarawa State. Whether you need a skilled artisan or are looking to showcase your craftsmanship, ArtisanHub is your go-to destination",
  },
  {
    id: 3,
    image: IMG3,
    ...
    description:
      "A wallet-based web application facilitating seamless cryptocurrency transactions and digital asset management and also provides utility bills payment seamlessly using a system. Built with modern web technologies, it integrates secure authentication, intuitive UI/UX, and real-time data updates to enhance user experience.",
  },
  {
    id: 4,
    image: IMG4,
  ...
  },
  {
    ...
    description:
      "ABF Accounting Services provides comprehensive accounting solutions for UK businesses of all sizes. Our team of professional accountants is dedicated to helping your business grow through tailored financial strategies and seamless compliance with UK regulations.",
  },

  {
    ...
    description:
      "Introducing FoodExportNG: Nigeria's Culinary Exports- the ultimate website for exploring and sourcing Nigerian food exports. Discover a diverse range of products, connect with trusted suppliers, and experience the vibrant flavors of Nigeria. Join us at FoodExportNG and embark on a delicious journey today!",
  },
  // {
  //   id: 7,
  //   image: IMG6,
      ...
      <div className="container portfolio_container">
        {data.map(({ id, image, title, github, demo, description }) => {
          return (
            <Project
              key={id}
              props={{ image, title, github, demo, description }}
            />
          );
        })}
      </div>
