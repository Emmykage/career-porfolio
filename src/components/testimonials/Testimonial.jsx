...
const data = [
  ...
  },
  {
    ...
    name: "Nastie Arinze",
    review:
      "A fantastic developer! Great cutomer support from beginning to end of the process. The team are really informed and go the extra mile at every stage. I would recommend them unreservedly.",
  },
  {
    avatar: AVT1,
    name: "Kay Muna",
    review:
      "I chatted with Morris. He was very helpful and answered all my questions concerning my product. I believe he had my interest at heart and found the best coverage for me at a good price.",
  },
];
